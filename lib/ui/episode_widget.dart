...
import 'package:flutter_ebox/ui/buy_error_dialog.dart';
                          ...
                          ? (widget.episodemodel.bought == episodebuy)
                              ...
                              : MyEpdataBT(
                                  ...
                                  tap: () {
                                    ...
                                    mybuyi(widget.episodemodel.id.toString());
                                  },
                                )
                          : Row(
                              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    Text(
                      ...
                      style:
                          textTheme.subtitle.copyWith(color: Colors.redAccent),
                    ),
                    Padding(
                      padding: const EdgeInsets.only(left: 8.0),
                      child: Text(
